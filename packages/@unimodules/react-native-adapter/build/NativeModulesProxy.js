...
export default new Proxy(NativeModulesProxy, {
    get: (target, propName, receiver) => {
        ...
        throw new CodedError('ERR_UNVAILABLE', `Native module ${String(propName)} is not available on ${Platform.OS}, are you sure you've linked all the native dependencies properly?`);
    },
    ownKeys: target => {
